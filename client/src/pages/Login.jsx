          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                type="email"
                required
                className="w-full px-3 py-2.5 bg-slate-950 border border-slate-800 rounded-lg placeholder-slate-500 text-slate-100 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm shadow-inner"
